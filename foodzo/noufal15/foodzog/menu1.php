...
<input type="text" class="search" id="searchid" placeholder="Search for Dishes" style="border-radius:15px;width:250px;margin-left:250px" />&nbsp; &nbsp;<input type="submit" value="Search" name="bt">&nbsp; &nbsp; <a href="#modal1"role="button"  data-toggle="modal" style="margin-bottom: 2%;background-color:green;text-decoration:none;color:white;padding:10px;border-radius:15px" name="adddoc" id="adddoc" >Change Location</a><br /> 
<div id="result">
</div>
</div>
...
<ul>          
  ...
  <div>
       <div class="col-md-3" id="right" class="col-md-3" id="myScrollspy"   style="position: relative;" >
...
<input type="hidden" name="qty_price"/>
              ...
              </a>  <h5 style="font-size:8px" lass="item_add">&nbsp;&nbsp;&nbsp;&nbsp;<span id=d1></span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href=''>x</a></h5><br><br><br>
