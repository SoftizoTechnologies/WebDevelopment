...
?>
     ...
     <div class="templatemo_product"><img style="width: 200px;height:150px;" src="images1/<?php echo $row[0];?>.jpg"/><br><br><strong><?php echo" Name:$row[1]<br> Address:$row[3]<br> Mobile No: $row[2]<br> Delivery Time:$row[6]<br>" 
     ?></strong><br /> 
