...
while($row1=mysqli_fetch_array($result1))
{
  ...
  $collapse3="#collapseThree".$i;
?>
                    <div class="panel panel-default aa-checkout-login">
                      <div class="panel-heading">
                        <h4 class="panel-title">
 <a data-toggle="collapse" data-parent="#accordion" href="<?php echo $collapse3;?>"><img src="<?php echo $img;?>" style="width: 150px;height:96px" /></a><br><br>
...
?> <br>
 ...
 <br><br>Review:<input type="text" name="review"/>&nbsp;&nbsp;&nbsp;&nbsp;<input type="Submit" name="button"/>
                      ...
                      <div id="<?php echo $collapse3;?>" class="panel-collapse collapse">
                        <div class="panel-body">
						    <a data-toggle="collapse" data-parent="#accordion" href="<?php echo $collapse3;?>">
					    ...
					    <div id="<?php echo $collapse3;?>" class="panel-collapse collapse" style="color:red;">
                        <div class="panel-body">
						    <a data-toggle="collapse" data-parent="#accordion" href="<?php echo $collapse3;?>>
                          My Order Details
                        </a>
...
<th>Status 
 ...
 <a data-toggle="collapse" data-parent="#accordion" href=<?php echo $collapse3;?>">
                      ...
                      <div id="<?php echo $collapse3;?> class="panel-collapse collapse in">
                        <div class="panel-body">
