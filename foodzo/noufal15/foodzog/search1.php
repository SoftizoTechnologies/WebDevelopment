...
while ($row = mysqli_fetch_array($result)){
					...
					//echo "<h1 style=margin-left:450px;color:red;>Order from ".$i." Restaurants<br></h1><h6 style=margin-left:550px;color:black;>delivering to your door</h6><br>"; 
					echo"<h4 style=margin-left:460px;color:red>Order from ".$i." Restaurants<br>Your Location:". $b1."</h4>";
				$_SESSION["loc"]=$i;
$_SESSION["rst"]=$b1;
...
?>
        <section>
            <article class="post">
                <?php echo " <a href='menu.php?id=$row[0]'><img src='images1/$row[0].jpg'  style=border-radius:10px;width:500px;height:100px></a>";?></a> 
...
echo "<br>";
	...
	{
		echo "<a href='#' class='button1'>Order Now</a>";
	}
	else
	{
		echo "<a href='#' class='button2'>Closed Now</a>";
	}
