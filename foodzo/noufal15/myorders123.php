...
?> <br>
 ...
 <div class="stars">
    ...
    <input class="star star-5[<?php echo $i;?>]" id="star-5[<?php echo $i;?>]" type="radio" value=1 name="star[<?php echo $i;?>]"/>

    <label class="star star-5[<?php echo $i;?>]" for="star-5[<?php echo $i;?>]"></label>

    <input class="star star-4[<?php echo $i;?>]" id="star-4[<?php echo $i;?>]" type="radio" value=2 name="star[<?php echo $i;?>]"/>
    ...
    <input class="star star-2[<?php echo $i;?>]" id="star-2[<?php echo $i;?>]" type="radio" value=4  name="star[<?php echo $i;?>]"/>

    <label class="star star-2[<?php echo $i;?>]" for="star-2[<?php echo $i;?>]"></label>

    <input class="star star-1[<?php echo $i;?>]" id="star-1[<?php echo $i;?>]" type="radio" value=5 name="star[<?php echo $i;?>]"/>
...
Date  & Time :<?php echo $row1[7];?>



 </td> <td><?php echo $row[4];?> </td> 
 
 <td> <br>Service Provider:  <?php echo $row2[1];?>
 
 <br><br>
 product Details :<br><br> SubTotal :<?php echo $row1[2];?>  <br><br> Delivery Charge : <?php echo $row1[4];?><br><br> <!--Taxes : <br><br>--> Order Total :<!--<?php echo $row1[6];?>-->
